...
export const AuthConfig: MessageFns<AuthConfig> = {
  ...
  fromPartial<I extends Exact<DeepPartial<AuthConfig>, I>>(object: I): AuthConfig {
    const message = createBaseAuthConfig();
    message.authTokenTtlSec = (object.authTokenTtlSec !== undefined && object.authTokenTtlSec !== null)
      ? BigInt(object.authTokenTtlSec)
      : 0n;
...
export const ServerConfig: MessageFns<ServerConfig> = {
  ...
  fromPartial<I extends Exact<DeepPartial<ServerConfig>, I>>(object: I): ServerConfig {
    ...
    message.logsRetentionSec = (object.logsRetentionSec !== undefined && object.logsRetentionSec !== null)
      ? BigInt(object.logsRetentionSec)
      : 0n;
    ...
    message.requestSizeLimitBytes =
      (object.requestSizeLimitBytes !== undefined && object.requestSizeLimitBytes !== null)
        ? BigInt(object.requestSizeLimitBytes)
        : 0n;
...
export const RecordApiConfig: MessageFns<RecordApiConfig> = {
  ...
  fromPartial<I extends Exact<DeepPartial<RecordApiConfig>, I>>(object: I): RecordApiConfig {
    ...
    message.listingHardLimit = (object.listingHardLimit !== undefined && object.listingHardLimit !== null)
      ? BigInt(object.listingHardLimit)
      : 0n;
    return message;
  },
